#!/usr/bin/env python3
"""
Configuration settings for the Postgres Backup and Restore System with shared repository and separate stanzas.
"""
...
class Settings:
    ...
    # pgBackRest configuration - Shared repository with separate stanzas
    PGBACKREST_CUSTOMER_STANZA = os.getenv("PGBACKREST_CUSTOMER_STANZA", "customer_demo")
    PGBACKREST_CUSTOMER_BACKUP_PATH = os.getenv("PGBACKREST_CUSTOMER_BACKUP_PATH", "/Users/aarthiprashanth/pgbackrest-repo")
    PGBACKREST_CUSTOMER_PGDATA = os.getenv("PGBACKREST_CUSTOMER_PGDATA", "/Users/aarthiprashanth/postgres/pg-customer")
    PGBACKREST_CONFIG_FILE = os.getenv("PGBACKREST_CONFIG_FILE", "/Users/aarthiprashanth/pgbackrest.conf")
    
    PGBACKREST_EMPLOYEE_STANZA = os.getenv("PGBACKREST_EMPLOYEE_STANZA", "employee_demo")
    PGBACKREST_EMPLOYEE_BACKUP_PATH = os.getenv("PGBACKREST_EMPLOYEE_BACKUP_PATH", "/Users/aarthiprashanth/pgbackrest-repo")
    PGBACKREST_EMPLOYEE_PGDATA = os.getenv("PGBACKREST_EMPLOYEE_PGDATA", "/Users/aarthiprashanth/postgres/pg-employee")
    ...
    # Database relationships for cross-database operations
    ...
    def get_pgbackrest_config(cls, server_name: str) -> Dict[str, str]:
        ...
        if server_name == "customerServer":
            return {
                ...
                "config_file": cls.PGBACKREST_CONFIG_FILE,
