...
class Settings:
    ...
    # pgBackRest configuration - Separate stanzas and paths for each server
    ...
    PGBACKREST_EMPLOYEE_BACKUP_PATH = os.getenv("PGBACKREST_EMPLOYEE_BACKUP_PATH", "/Users/aarthiprashanth/backups/pgbackrest_employee")
