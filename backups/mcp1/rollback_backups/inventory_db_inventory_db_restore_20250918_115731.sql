...
\restrict cMMr5hbwde73hPphNB6VcWAlRvXGMKwvEZJxRL8ie3FVMQpR5cVnMIeRTDayHW3

-- Dumped from database version 17.6 (Postgres.app)
-- Dumped by pg_dump version 17.6 (Postgres.app)

-- Started on 2025-09-18 11:57:32 IST
...
--
-- TOC entry 217 (class 1259 OID 34703)
...
--
-- TOC entry 218 (class 1259 OID 34711)
...
--
-- TOC entry 219 (class 1259 OID 34712)
...
CREATE TABLE public.inventory_movements (
    ...
    notes text,
    CONSTRAINT valid_movement_type CHECK (((movement_type)::text = ANY (ARRAY[('inbound'::character varying)::text, ('outbound'::character varying)::text, ('adjustment'::character varying)::text])))
);
...
--
-- TOC entry 220 (class 1259 OID 34719)
...
--
-- TOC entry 221 (class 1259 OID 34720)
...
--
-- TOC entry 222 (class 1259 OID 34727)
...
--
-- TOC entry 3528 (class 2604 OID 34728)
...
--
-- TOC entry 3532 (class 2604 OID 34729)
...
--
-- TOC entry 3534 (class 2604 OID 34730)
...
--
-- TOC entry 3701 (class 0 OID 34703)
-- Dependencies: 217
...
1	1	Warehouse-A	45	10	2025-09-18 11:51:37.426357
2	2	Warehouse-A	120	25	2025-09-18 11:51:37.426357
3	3	Warehouse-B	8	5	2025-09-18 11:51:37.426357
4	4	Warehouse-A	32	15	2025-09-18 11:51:37.426357
5	5	Warehouse-A	67	20	2025-09-18 11:51:37.426357
6	6	Warehouse-B	15	8	2025-09-18 11:51:37.426357
7	7	Warehouse-A	88	30	2025-09-18 11:51:37.426357
8	8	Warehouse-A	42	12	2025-09-18 11:51:37.426357
\.


--
-- TOC entry 3703 (class 0 OID 34712)
-- Dependencies: 219
...
1	1	inbound	50	2025-09-18 11:51:37.427195	PO-2025-001	Received shipment from supplier
2	2	outbound	-25	2025-09-18 11:51:37.427195	SO-2025-015	Sold to customer order
3	3	adjustment	-2	2025-09-18 11:51:37.427195	ADJ-2025-003	Damaged units removed
4	4	inbound	40	2025-09-18 11:51:37.427195	PO-2025-002	New stock arrival
5	5	outbound	-15	2025-09-18 11:51:37.427195	SO-2025-016	Bulk order shipment
6	6	inbound	20	2025-09-18 11:51:37.427195	PO-2025-003	Restocking furniture
7	7	outbound	-12	2025-09-18 11:51:37.427195	SO-2025-017	Corporate order
8	8	adjustment	5	2025-09-18 11:51:37.427195	ADJ-2025-004	Inventory count correction
\.


--
-- TOC entry 3705 (class 0 OID 34720)
-- Dependencies: 221
-- Data for Name: products; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.products (product_id, sku, product_name, description, category, unit_price, created_at) FROM stdin;
1	LAP-001	Business Laptop	15-inch business laptop with SSD	Electronics	899.99	2025-09-18 11:51:37.425824
2	MOU-001	Wireless Mouse	Ergonomic wireless mouse	Electronics	29.99	2025-09-18 11:51:37.425824
3	DES-001	Standing Desk	Adjustable height standing desk	Furniture	349.99	2025-09-18 11:51:37.425824
4	MON-001	Monitor 24inch	24-inch LED monitor	Electronics	199.99	2025-09-18 11:51:37.425824
5	KEY-001	Mechanical Keyboard	RGB mechanical keyboard	Electronics	129.99	2025-09-18 11:51:37.425824
6	CHR-001	Office Chair	Ergonomic office chair	Furniture	299.99	2025-09-18 11:51:37.425824
7	CAM-001	Webcam HD	1080p HD webcam	Electronics	79.99	2025-09-18 11:51:37.425824
8	HED-001	Noise Cancelling Headphones	Wireless noise cancelling headphones	Electronics	199.99	2025-09-18 11:51:37.425824
\.
...
--
-- TOC entry 3547 (class 2606 OID 34732)
...
--
-- TOC entry 3543 (class 2606 OID 34734)
...
--
-- TOC entry 3551 (class 2606 OID 34736)
...
--
-- TOC entry 3553 (class 2606 OID 34738)
...
--
-- TOC entry 3540 (class 1259 OID 34739)
...
--
-- TOC entry 3541 (class 1259 OID 34740)
...
--
-- TOC entry 3544 (class 1259 OID 34741)
...
--
-- TOC entry 3545 (class 1259 OID 34742)
...
--
-- TOC entry 3548 (class 1259 OID 34743)
...
--
-- TOC entry 3549 (class 1259 OID 34744)
...
--
-- TOC entry 3555 (class 2606 OID 34745)
...
--
-- TOC entry 3554 (class 2606 OID 34750)
...
-- Completed on 2025-09-18 11:57:32 IST

--
-- PostgreSQL database dump complete
--

\unrestrict cMMr5hbwde73hPphNB6VcWAlRvXGMKwvEZJxRL8ie3FVMQpR5cVnMIeRTDayHW3
