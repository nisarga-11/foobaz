...
class MCPServer2:
    def __init__(self):
        ...
        self.port = 5002
        self.stanza = "pg2_17"
        self.pg_path = "/var/lib/postgresql/17/pg2_17"

        # CrewAI Agent for PG2
        self.agent = Agent(
            name="PG2 Backup Agent",
            role="PostgreSQL Backup and Restore Specialist for PG2",
            goal="Manage backups and restores for PostgreSQL Server 2 (pg2_17)",
            backstory=(
