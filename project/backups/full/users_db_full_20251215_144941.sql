...
\restrict EeFxcSyNAadOiCBx229ETa2RfrbVWuzHl3tJaZj1LBoxlrJuFgXkfnuITs2dELF
...
--
-- Name: restore_test; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.restore_test OWNER TO postgres;

--
-- Name: restore_test_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.restore_test_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.restore_test_id_seq OWNER TO postgres;

--
-- Name: restore_test_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.restore_test_id_seq OWNED BY public.restore_test.id;
...
--
-- Name: restore_test id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.restore_test ALTER COLUMN id SET DEFAULT nextval('public.restore_test_id_seq'::regclass);
...
--
-- Data for Name: restore_test; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.restore_test (id, name, created_at) FROM stdin;
1	BEFORE_RESTORE_TEST	2025-12-10 17:21:10.16097
35	AFTER BASE BACKUP BEFORE RESTORE	2025-12-11 02:58:56.893601
\.
...
--
-- Name: restore_test_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.restore_test_id_seq', 67, true);
...
--
-- Name: restore_test restore_test_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.restore_test
    ADD CONSTRAINT restore_test_pkey PRIMARY KEY (id);
...
\unrestrict EeFxcSyNAadOiCBx229ETa2RfrbVWuzHl3tJaZj1LBoxlrJuFgXkfnuITs2dELF
